def calcular_media_notas_turma():
    print("Cálculo da média das notas de uma turma qualquer\n")
    ...
    print(f"Soma total das notas:              {soma_notas:8.2f}")
    print(f"Média das notas da turma:          {media:8.2f}")
    print("=" * 60)

# Execução do programa
if __name__ == "__main__":
    calcular_media_notas_turma()